...
public class hospitalDetails extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 80, -1, 288));
        getContentPane().add(jSeparator2, new org.netbeans.lib.awtextra.AbsoluteConstraints(6, 384, 688, 0));
    ...
    try {
            ...
            model.setRowCount(0);
            model.setColumnIdentifiers(new Object[]{ "Hospital Name","Hospital ID", "Hospital Address"});

            while (rs.next()) {
                

                 Object[] row = {rs.getString("HospitalName"), rs.getString("RegNo"),rs.getString("Address")};
                model.addRow(row);
            }
        }
    catch (Exception e) {
