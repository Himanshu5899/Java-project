...
public class addNewDonor extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 10, 292, -1));
        getContentPane().add(jSeparator1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 70, 700, 10));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(477, 247, 210, -1));
        ...
        getContentPane().add(jButton4, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 430, 100, 30));
        ...
        getContentPane().add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 100, 70, 20));
...
try {
           Connection con=ConnectionProvider.getCon();
            if(con!=null)
            {
                String query ="Insert into donor( userid,Name,FatherName,MotherName,DOB,Mobile,Gender,Email,BloodGroup,City,Address)values(?,?,?,?,?,?,?,?,?,?,?)";
...
JOptionPane.showMessageDialog(null,"Successfully Added New Donor !! YOUR ID NUMBER ='"+donorId+""); 
setVisible(false); 
new addNewDonor().setVisible(true); 
              }
}catch(Exception e){ 
    e.printStackTrace();
    //JOptionPane.showMessageDialog(null,"Kindaly Fill the Adding Process"); 
}
    ...
    private void formComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_formComponentShown
        // TODO add your handling code here:
            ...
            try{
              ...
              ResultSet rs=st.executeQuery("select max(userid) from donor");
              if(rs.next())
              {int id=rs.getInt(1);
              id=id+1;
